...
function runtime_stats.summaryLines()
    return {
        ...
        string.format(
            "chaos_budget default=%d chaos=%d cap_reject=%d projectile_reject=%d job_reject=%d depth_reject=%d queue_reject=%d fanout_reject=%d launch_density_throttle=%d high_fanout_smoke=%d max_jobs=%d max_queue=%d max_projectiles=%d max_live_launches_per_tick=%d",
