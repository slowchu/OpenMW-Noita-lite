...
defs.FEATURE_DEFS = {
    ...
    },
    {
        ...
        summary = "Bounded depth-2 Trigger/Timer chains, including same-kind and mixed-kind nesting.",
    },
    {
        ...
        summary = "Bounded final Multicast, pattern, modifier, Homing, or non-recursive Chain payloads after Pack G depth-2 Trigger/Timer chains.",
    },
    {
        id = "speed_plus",
        display_name = "Speed+",
    ...
    },
    {
        ...
        summary = "Launch-time Homing composition for bounded source and Trigger/Timer payload launch surfaces, with optional central soft-Homing.",
    },
}
