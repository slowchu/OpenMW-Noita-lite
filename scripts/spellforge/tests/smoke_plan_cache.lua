...
local function run()
    ...
    assertLine(catalog.base_effect_count and catalog.base_effect_count > 0, "15 ui catalog exposes available base effects")
    assertLine(catalog.available_effect_source_mode == "fallback_static", "15 ui catalog records fallback base-effect source")
    assertLine(catalog.events and catalog.events.query_available_effects == "Spellforge_QueryAvailableEffects", "15 ui catalog includes available-effects event name")
